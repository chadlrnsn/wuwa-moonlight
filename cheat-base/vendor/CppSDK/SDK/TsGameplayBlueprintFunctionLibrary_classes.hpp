...
public:
	...
	static void DebugResetBaseValue(int32 EntityId, float Id, float Val, class UObject* __WorldContext);
	...
	static void AddBuffToTargetById(int32 EntityId, class ATsBaseCharacter_C* Target, int64 buffId, class UObject* __WorldContext);
	...
	static void ChangeCameraToEntityCamera(class UObject* __WorldContext);
	...
	static void ApplyBuffWithLevel(int32 EntityId, int64 buffId, int32 SkillId, class UObject* __WorldContext);
	...
	static void AddBuffToTargetEntityById(int32 InstigatorEntityId, int32 TargetEntityId, int64 buffId, class UObject* __WorldContext);
