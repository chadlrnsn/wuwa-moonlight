...
public:
	...
	class USkeletalMeshComponent*                 OtherCase1;                                        // 0x0798(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_Jianxin_C) == 0x0007B0, "Wrong size on ABP_Jianxin_C");
...
static_assert(offsetof(ABP_Jianxin_C, Bip001LThighTwist) == 0x000780, "Member 'ABP_Jianxin_C::Bip001LThighTwist' has a wrong offset!");
static_assert(offsetof(ABP_Jianxin_C, Bip001RThighTwist) == 0x000788, "Member 'ABP_Jianxin_C::Bip001RThighTwist' has a wrong offset!");
static_assert(offsetof(ABP_Jianxin_C, Bip001Spine2) == 0x000790, "Member 'ABP_Jianxin_C::Bip001Spine2' has a wrong offset!");
static_assert(offsetof(ABP_Jianxin_C, OtherCase1) == 0x000798, "Member 'ABP_Jianxin_C::OtherCase1' has a wrong offset!");
static_assert(offsetof(ABP_Jianxin_C, WeaponCase1) == 0x0007A0, "Member 'ABP_Jianxin_C::WeaponCase1' has a wrong offset!");
static_assert(offsetof(ABP_Jianxin_C, WeaponCase0) == 0x0007A8, "Member 'ABP_Jianxin_C::WeaponCase0' has a wrong offset!");
