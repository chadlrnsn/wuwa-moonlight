...
// 0x0010 (0x0010 - 0x0000)
struct AnimNotifyStateEffect_C_CacheEffectHandle final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(AnimNotifyStateEffect_C_CacheEffectHandle) == 0x000008, "Wrong alignment on AnimNotifyStateEffect_C_CacheEffectHandle");
static_assert(sizeof(AnimNotifyStateEffect_C_CacheEffectHandle) == 0x000010, "Wrong size on AnimNotifyStateEffect_C_CacheEffectHandle");
static_assert(offsetof(AnimNotifyStateEffect_C_CacheEffectHandle, MeshComp) == 0x000000, "Member 'AnimNotifyStateEffect_C_CacheEffectHandle::MeshComp' has a wrong offset!");
static_assert(offsetof(AnimNotifyStateEffect_C_CacheEffectHandle, EffectHandle) == 0x000008, "Member 'AnimNotifyStateEffect_C_CacheEffectHandle::EffectHandle' has a wrong offset!");
