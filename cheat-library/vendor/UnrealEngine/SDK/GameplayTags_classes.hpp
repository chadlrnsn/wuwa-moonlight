...
public:
	...
	uint8                                         Pad_261C[0x10];                                    // 0x0040(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_261D[0x98];                                    // 0x0030(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayTagSource>             TagSources;                                        // 0x00C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_261E[0xE0];                                    // 0x00D8(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x01B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_261F[0x50];                                    // 0x01C8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2620[0x5];                                     // 0x0053(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2621[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
