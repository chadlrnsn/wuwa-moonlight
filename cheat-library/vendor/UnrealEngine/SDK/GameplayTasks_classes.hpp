...
{
public:
	uint8                                         Pad_105F[0xC];                                     // 0x00C0(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_43 : 1;                                     // 0x00CC(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	...
	uint8                                         Pad_1060[0x3];                                     // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1061[0x10];                                    // 0x00F0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1064[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1065[0x2];                                     // 0x0044(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1066[0x21];                                    // 0x0047(0x0021)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1069[0x18];                                    // 0x0090(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_106C[0x10];                                    // 0x0090(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1070[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
