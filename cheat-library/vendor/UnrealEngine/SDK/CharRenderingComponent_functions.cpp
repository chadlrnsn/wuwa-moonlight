...
bool UCharRenderingComponent_C::GetInWater()
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   Handle                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCharRenderingComponent_C::RegisterBodyEffect(float Handle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CharRenderingComponent_C", "RegisterBodyEffect");

	Params::CharRenderingComponent_C_RegisterBodyEffect Parms{};
