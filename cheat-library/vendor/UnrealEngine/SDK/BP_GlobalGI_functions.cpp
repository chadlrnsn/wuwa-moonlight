...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AKuroRainActor*                   RainActor                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FVector                          Wind                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    UpdateHeightMapTexture                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    RainValid                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void ABP_GlobalGI_C::UpdateRainOrSnowImp(class AKuroRainActor* RainActor, float Density, float Gravity, const struct FVector& Wind, bool UpdateHeightMapTexture, bool* RainValid)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GlobalGI_C", "UpdateRainOrSnowImp");

	Params::BP_GlobalGI_C_UpdateRainOrSnowImp Parms{};

	Parms.RainActor = RainActor;
	Parms.Density = Density;
	Parms.Gravity = Gravity;
	Parms.Wind = std::move(Wind);
	Parms.UpdateHeightMapTexture = UpdateHeightMapTexture;

	UObject::ProcessEvent(Func, &Parms);

	if (RainValid != nullptr)
		*RainValid = Parms.RainValid;
}
