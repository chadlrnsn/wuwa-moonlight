...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Common_limitmove_C;              // 0x0530(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Common_limitmove_C) == 0x000538, "Wrong size on UGA_Common_limitmove_C");
static_assert(offsetof(UGA_Common_limitmove_C, UberGraphFrame_GA_Common_limitmove_C) == 0x000530, "Member 'UGA_Common_limitmove_C::UberGraphFrame_GA_Common_limitmove_C' has a wrong offset!");
