...
public:
	...
	uint8                                         Pad_2FFC[0x3];                                     // 0x02D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2FFD[0x3];                                     // 0x02ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class ABP_GlobalGI_C*                         CachedGlobalGI;                                    // 0x0398(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           ColorTint;                                         // 0x03A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_SuperFarFog_C) == 0x0003B0, "Wrong size on ABP_SuperFarFog_C");
...
static_assert(offsetof(ABP_SuperFarFog_C, CachedGlobalGI) == 0x000398, "Member 'ABP_SuperFarFog_C::CachedGlobalGI' has a wrong offset!");
static_assert(offsetof(ABP_SuperFarFog_C, ColorTint) == 0x0003A0, "Member 'ABP_SuperFarFog_C::ColorTint' has a wrong offset!");
