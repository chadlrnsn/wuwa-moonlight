...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Interaction_Bounce_C;            // 0x0530(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Interaction_Bounce_C) == 0x000540, "Wrong size on UGA_Interaction_Bounce_C");
static_assert(offsetof(UGA_Interaction_Bounce_C, UberGraphFrame_GA_Interaction_Bounce_C) == 0x000530, "Member 'UGA_Interaction_Bounce_C::UberGraphFrame_GA_Interaction_Bounce_C' has a wrong offset!");
static_assert(offsetof(UGA_Interaction_Bounce_C, __i) == 0x000538, "Member 'UGA_Interaction_Bounce_C::__i' has a wrong offset!");
