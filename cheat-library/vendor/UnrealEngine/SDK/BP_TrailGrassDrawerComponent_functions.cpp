...
// Parameters:
// struct FSTrailGrassDrawInfo             DrawInfo                                               (Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_TrailGrassDrawerComponent_C::GetDrawInfo(struct FSTrailGrassDrawInfo* DrawInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_TrailGrassDrawerComponent_C", "GetDrawInfo");

	Params::BP_TrailGrassDrawerComponent_C_GetDrawInfo Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (DrawInfo != nullptr)
		*DrawInfo = std::move(Parms.DrawInfo);
}
