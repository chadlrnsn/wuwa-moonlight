...
void UGA_Destroy_Zhaohuan_Vision_C::Four_iP___(int32 P_ID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Destroy_Zhaohuan_Vision_C", "4iP(Ó_");

	Params::GA_Destroy_Zhaohuan_Vision_C_Four_iP___ Parms{};
...
void UGA_Destroy_Zhaohuan_Vision_C::P___(int32 P_ID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Destroy_Zhaohuan_Vision_C", "P(Ó_");

	Params::GA_Destroy_Zhaohuan_Vision_C_P___ Parms{};
...
void UGA_Destroy_Zhaohuan_Vision_C::_______4()
{
	static class UFunction* Func = nullptr;
