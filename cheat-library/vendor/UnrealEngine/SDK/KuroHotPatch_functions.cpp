...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TDelegate<void(uint8 DownloadState, int32 HttpState)>InCb                                                   (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TDelegate<void(int64 ThisTimeReceiveSize, int64 ReceivedSize, int64 SavedSize)>InCb                                                   (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
