...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_MO1DujiaoshouMd00001_Attack01_C; // 0x0540(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UAnimMontage*                           Montage_to_Play;                                   // 0x0548(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_MO1DujiaoshouMd00001_Attack01_C) == 0x000550, "Wrong size on UGA_MO1DujiaoshouMd00001_Attack01_C");
static_assert(offsetof(UGA_MO1DujiaoshouMd00001_Attack01_C, UberGraphFrame_GA_MO1DujiaoshouMd00001_Attack01_C) == 0x000540, "Member 'UGA_MO1DujiaoshouMd00001_Attack01_C::UberGraphFrame_GA_MO1DujiaoshouMd00001_Attack01_C' has a wrong offset!");
static_assert(offsetof(UGA_MO1DujiaoshouMd00001_Attack01_C, Montage_to_Play) == 0x000548, "Member 'UGA_MO1DujiaoshouMd00001_Attack01_C::Montage_to_Play' has a wrong offset!");
