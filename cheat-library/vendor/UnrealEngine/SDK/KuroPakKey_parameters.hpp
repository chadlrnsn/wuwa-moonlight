...
{
public:
	TDelegate<void(bool Success)>                 Callback;                                          // 0x0000(0x0014)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(KuroPakKeyLibrary_SetCompleteCallback) == 0x000014, "Wrong size on KuroPakKeyLibrary_SetCompleteCallback");
