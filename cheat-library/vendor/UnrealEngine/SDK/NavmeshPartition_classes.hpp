...
{
public:
	uint8                                         Pad_1B00[0x18];                                    // 0x0218(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1B01[0x58];                                    // 0x0218(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1B02[0xA8];                                    // 0x0218(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
