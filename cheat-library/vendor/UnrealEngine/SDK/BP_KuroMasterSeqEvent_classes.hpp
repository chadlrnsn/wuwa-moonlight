...
public:
	...
	uint8                                         Pad_312A[0x7];                                     // 0x02B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ______();
	void ______0();
	void _____(bool ShouldBlend, float blendTime, EViewTargetBlendFunction blendFunction, float blendExp);
	void O____();
