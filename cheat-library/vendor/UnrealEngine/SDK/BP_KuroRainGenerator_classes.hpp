...
public:
	...
	class UNiagaraComponent*                      Niagara_CommonReverse_UrgentTurn;                  // 0x02C8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UBP_RainComponent_CommonReverse_C*      BP_RainComponent_CommonReverse_UrgentTurn;         // 0x02D0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      Niagara_CommonReverse_Fast;                        // 0x02D8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UBP_RainComponent_CommonReverse_C*      BP_RainComponent_CommonReverse_Fast;               // 0x02E0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      Niagara_CommonReverse_Stable;                      // 0x02E8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      Niagara_CommonDrop;                                // 0x02F0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      Niagara_CommonReverse_Lively;                      // 0x02F8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UBP_RainComponent_CommonReverse_C*      BP_RainComponent_CommonReverse_Stable;             // 0x0300(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UBP_RainComponent_CommonDrop_C*         BP_RainComponent_CommonDrop;                       // 0x0308(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_1DB5[0x2];                                     // 0x0336(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ABP_KuroRainGenerator_C, Niagara_CommonReverse_UrgentTurn) == 0x0002C8, "Member 'ABP_KuroRainGenerator_C::Niagara_CommonReverse_UrgentTurn' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, BP_RainComponent_CommonReverse_UrgentTurn) == 0x0002D0, "Member 'ABP_KuroRainGenerator_C::BP_RainComponent_CommonReverse_UrgentTurn' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, Niagara_CommonReverse_Fast) == 0x0002D8, "Member 'ABP_KuroRainGenerator_C::Niagara_CommonReverse_Fast' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, BP_RainComponent_CommonReverse_Fast) == 0x0002E0, "Member 'ABP_KuroRainGenerator_C::BP_RainComponent_CommonReverse_Fast' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, Niagara_CommonReverse_Stable) == 0x0002E8, "Member 'ABP_KuroRainGenerator_C::Niagara_CommonReverse_Stable' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, Niagara_CommonDrop) == 0x0002F0, "Member 'ABP_KuroRainGenerator_C::Niagara_CommonDrop' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, Niagara_CommonReverse_Lively) == 0x0002F8, "Member 'ABP_KuroRainGenerator_C::Niagara_CommonReverse_Lively' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, BP_RainComponent_CommonReverse_Stable) == 0x000300, "Member 'ABP_KuroRainGenerator_C::BP_RainComponent_CommonReverse_Stable' has a wrong offset!");
static_assert(offsetof(ABP_KuroRainGenerator_C, BP_RainComponent_CommonDrop) == 0x000308, "Member 'ABP_KuroRainGenerator_C::BP_RainComponent_CommonDrop' has a wrong offset!");
