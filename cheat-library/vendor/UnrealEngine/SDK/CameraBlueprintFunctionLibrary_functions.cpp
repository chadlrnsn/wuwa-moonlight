...
// Parameters:
// struct FSSequenceCamera_Settings        Settings                                               (BlueprintVisible, BlueprintReadOnly, Parm, UObjectWrapper, HasGetValueTypeHash)
// bool                                    ResetFightCamera                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
// struct FRotator                         AdditiveRotation                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
...
// class FString                           SocketName1                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// class FString                           LockSocketName1                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
// float                                   Radius                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
// bool                                    IsShowLine                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)

bool UCameraBlueprintFunctionLibrary_C::PlayCameraSequence(const struct FSSequenceCamera_Settings& Settings, bool ResetFightCamera, const struct FRotator& AdditiveRotation, class ATsBaseCharacter_C* Target, const class FString& SocketName1, const class FString& LockSocketName1, const struct FVector& RelativeLocation, float Radius, bool IsShowLine, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ResetFightCamera = ResetFightCamera;
	Parms.AdditiveRotation = std::move(AdditiveRotation);
	Parms.Target = Target;
	Parms.SocketName1 = std::move(SocketName1);
	Parms.LockSocketName1 = std::move(LockSocketName1);
	Parms.RelativeLocation = std::move(RelativeLocation);
	Parms.Radius = Radius;
	Parms.IsShowLine = IsShowLine;
	Parms.__WorldContext = __WorldContext;
