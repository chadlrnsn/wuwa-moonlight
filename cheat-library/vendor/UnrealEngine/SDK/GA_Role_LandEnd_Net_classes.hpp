...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Role_LandEnd_Net_C;              // 0x0530(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Role_LandEnd_Net_C) == 0x000538, "Wrong size on UGA_Role_LandEnd_Net_C");
static_assert(offsetof(UGA_Role_LandEnd_Net_C, UberGraphFrame_GA_Role_LandEnd_Net_C) == 0x000530, "Member 'UGA_Role_LandEnd_Net_C::UberGraphFrame_GA_Role_LandEnd_Net_C' has a wrong offset!");
