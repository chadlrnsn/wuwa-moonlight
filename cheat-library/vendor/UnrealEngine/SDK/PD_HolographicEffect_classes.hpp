...
public:
	...
	uint8                                         Pad_2E7C[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSHolographicData                      OutlineData;                                       // 0x0048(0x0040)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	struct FSHolographicData                      OtherData;                                         // 0x0088(0x0040)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UPD_HolographicEffect_C) == 0x0000C8, "Wrong size on UPD_HolographicEffect_C");
...
static_assert(offsetof(UPD_HolographicEffect_C, OtherData) == 0x000088, "Member 'UPD_HolographicEffect_C::OtherData' has a wrong offset!");
