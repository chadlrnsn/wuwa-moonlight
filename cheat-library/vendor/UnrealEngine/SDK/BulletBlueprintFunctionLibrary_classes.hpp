...
public:
	...
	static int32 CreateBullet(class ATsBaseCharacter_C* Owner, const class FString& bulletRowName, const struct FTransform& InitialTransform, const class FString& SkillId, bool NeedSync, const struct FVector& TargetLocation, class UObject* __WorldContext);
	static int32 CreateBulletFromAN(class ATsBaseCharacter_C* Owner, const class FString& bulletRowName, const struct FTransform& InitialTransform, const class FString& SkillId, bool NeedSync, const struct FVector& TargetLocation, class UObject* __WorldContext);
