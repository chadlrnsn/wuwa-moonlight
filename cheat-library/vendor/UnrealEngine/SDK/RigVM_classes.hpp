...
public:
	...
	uint8                                         Pad_2847[0x8];                                     // 0x00D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMMemoryContainer                  LiteralMemoryStorage;                              // 0x00D8(0x00A0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_2848[0x8];                                     // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0180(0x0030)(NativeAccessSpecifierPublic)
	uint8                                         Pad_2849[0x8];                                     // 0x01B0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_284A[0x20];                                    // 0x0238(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_284B[0x48];                                    // 0x02B8(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
