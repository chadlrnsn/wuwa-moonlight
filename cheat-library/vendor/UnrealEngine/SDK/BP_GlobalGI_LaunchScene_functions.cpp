...
void ABP_GlobalGI_LaunchScene_C::GetStarsDMI(class UMaterialInstanceDynamic** DMIRet)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GlobalGI_LaunchScene_C", "GetStarsDMI");

	Params::BP_GlobalGI_LaunchScene_C_GetStarsDMI Parms{};
...
void ABP_GlobalGI_LaunchScene_C::GetAuroraDMI(class UMaterialInstanceDynamic** DMIRet)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GlobalGI_LaunchScene_C", "GetAuroraDMI");

	Params::BP_GlobalGI_LaunchScene_C_GetAuroraDMI Parms{};
