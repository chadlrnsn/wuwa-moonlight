...
public:
	...
	struct FWorldPartitionStreamingQuerySource    None_3;                                            // 0x0000(0x0030)(HasGetValueTypeHash)
	struct FVector                                None_4;                                            // 0x0000(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSCameraConfig                         None_5;                                            // 0x0000(0x0738)(HasGetValueTypeHash)
	class AActor*                                 None_6;                                            // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAnimationAsset*                        None_9;                                            // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FAnimNotifyEvent                       None_10;                                           // 0x0000(0x00C8)(HasGetValueTypeHash)
	class UAnimSequenceBase*                      None_11;                                           // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 None_15;                                           // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash)
};
...
{
public:
	uint8                                         Pad_1B7B[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1B7C[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
