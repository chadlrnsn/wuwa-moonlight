...
public:
	...
	TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)> ___delegate_Variable;                              // 0x0028(0x0014)(ConstParm, ZeroConstructor, NoDestructor)
	int32                                         CallFunc_PostAkEvent_ReturnValue;                  // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetSourcePlayPosition_ReturnValue;        // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetRTPCValue_Value;                       // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ERTPCValueType                                CallFunc_GetRTPCValue_OutputValueType;             // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3158[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3159[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 CallFunc_GetNormalizedChannelConstantQAtTime_OutConstantQ; // 0x0058(0x0010)(ReferenceParm)
...
static_assert(sizeof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum) == 0x000070, "Wrong size on BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum");
...
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_PostAkEvent_ReturnValue) == 0x00003C, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_PostAkEvent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_GetSourcePlayPosition_ReturnValue) == 0x000040, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_GetSourcePlayPosition_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_GetRTPCValue_Value) == 0x000044, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_GetRTPCValue_Value' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_GetRTPCValue_OutputValueType) == 0x000048, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_GetRTPCValue_OutputValueType' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00004C, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000050, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_GetNormalizedChannelConstantQAtTime_OutConstantQ) == 0x000058, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_GetNormalizedChannelConstantQAtTime_OutConstantQ' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_Array_Length_ReturnValue) == 0x000068, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum, CallFunc_Less_IntInt_ReturnValue) == 0x00006C, "Member 'BP_Wwise_AudioSpectrum_C_ExecuteUbergraph_BP_Wwise_AudioSpectrum::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
