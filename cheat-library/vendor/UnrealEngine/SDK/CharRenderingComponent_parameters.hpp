...
public:
	...
	uint8                                         Pad_3483[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3484[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	ECharacterBodySpecifiedType                   bodyType;                                          // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	uint8                                         Pad_3485[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SectionIndex;                                      // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	ECharacterSlotSpecifiedType                   SlotType;                                          // 0x0008(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
// Function CharRenderingComponent.CharRenderingComponent_C.RegisterBodyEffect
// 0x0004 (0x0004 - 0x0000)
struct CharRenderingComponent_C_RegisterBodyEffect final
{
public:
	float                                         Handle;                                            // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(CharRenderingComponent_C_RegisterBodyEffect) == 0x000004, "Wrong alignment on CharRenderingComponent_C_RegisterBodyEffect");
static_assert(sizeof(CharRenderingComponent_C_RegisterBodyEffect) == 0x000004, "Wrong size on CharRenderingComponent_C_RegisterBodyEffect");
static_assert(offsetof(CharRenderingComponent_C_RegisterBodyEffect, Handle) == 0x000000, "Member 'CharRenderingComponent_C_RegisterBodyEffect::Handle' has a wrong offset!");
