...
public:
	...
	uint8                                         Pad_3002[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3003[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3004[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3005[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3006[0xC];                                     // 0x00D4(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
// 0x0018 (0x0018 - 0x0000)
struct Audio_Multi_Base_C_Play final
{
public:
	TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)> ___delegate_Variable;                              // 0x0000(0x0014)(ConstParm, ZeroConstructor, NoDestructor)
	int32                                         CallFunc_PostAkEvent_ReturnValue;                  // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Audio_Multi_Base_C_Play) == 0x000004, "Wrong alignment on Audio_Multi_Base_C_Play");
static_assert(sizeof(Audio_Multi_Base_C_Play) == 0x000018, "Wrong size on Audio_Multi_Base_C_Play");
...
static_assert(offsetof(Audio_Multi_Base_C_Play, CallFunc_PostAkEvent_ReturnValue) == 0x000014, "Member 'Audio_Multi_Base_C_Play::CallFunc_PostAkEvent_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3007[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3009[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
struct Audio_Multi_Base_C_GamePlay final
{
public:
...
static_assert(alignof(Audio_Multi_Base_C_GamePlay) == 0x000004, "Wrong alignment on Audio_Multi_Base_C_GamePlay");
static_assert(sizeof(Audio_Multi_Base_C_GamePlay) == 0x00001C, "Wrong size on Audio_Multi_Base_C_GamePlay");
...
static_assert(offsetof(Audio_Multi_Base_C_GamePlay, ___delegate_Variable) == 0x000004, "Member 'Audio_Multi_Base_C_GamePlay::___delegate_Variable' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C_GamePlay, CallFunc_PostAkEvent_ReturnValue) == 0x000018, "Member 'Audio_Multi_Base_C_GamePlay::CallFunc_PostAkEvent_ReturnValue' has a wrong offset!");
