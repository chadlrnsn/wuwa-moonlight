...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Relax_Vision_C;                  // 0x0530(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Relax_Vision_C) == 0x000540, "Wrong size on UGA_Relax_Vision_C");
static_assert(offsetof(UGA_Relax_Vision_C, UberGraphFrame_GA_Relax_Vision_C) == 0x000530, "Member 'UGA_Relax_Vision_C::UberGraphFrame_GA_Relax_Vision_C' has a wrong offset!");
static_assert(offsetof(UGA_Relax_Vision_C, ___) == 0x000538, "Member 'UGA_Relax_Vision_C::___' has a wrong offset!");
