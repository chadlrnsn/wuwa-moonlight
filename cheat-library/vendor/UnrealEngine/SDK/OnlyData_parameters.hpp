...
public:
	...
	uint8                                         Pad_3289[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsFind;                                            // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_328A[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsFind;                                            // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_328B[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSReBulletDataMain                     BulletData;                                        // 0x0020(0x06E8)(Parm, OutParm, HasGetValueTypeHash)
	class FName                                   CallFunc_Conv_StringToName_ReturnValue;            // 0x0708(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_328C[0x4];                                     // 0x0714(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSReBulletDataMain                     CallFunc_GetDataTableRowFromName_OutRow;           // 0x0718(0x06E8)(HasGetValueTypeHash)
	bool                                          CallFunc_GetDataTableRowFromName_ReturnValue;      // 0x0E00(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(OnlyData_C_GetCommonNewBulletData) == 0x000008, "Wrong alignment on OnlyData_C_GetCommonNewBulletData");
static_assert(sizeof(OnlyData_C_GetCommonNewBulletData) == 0x000E08, "Wrong size on OnlyData_C_GetCommonNewBulletData");
...
static_assert(offsetof(OnlyData_C_GetCommonNewBulletData, CallFunc_Conv_StringToName_ReturnValue) == 0x000708, "Member 'OnlyData_C_GetCommonNewBulletData::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(OnlyData_C_GetCommonNewBulletData, CallFunc_GetDataTableRowFromName_OutRow) == 0x000718, "Member 'OnlyData_C_GetCommonNewBulletData::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(OnlyData_C_GetCommonNewBulletData, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000E00, "Member 'OnlyData_C_GetCommonNewBulletData::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
