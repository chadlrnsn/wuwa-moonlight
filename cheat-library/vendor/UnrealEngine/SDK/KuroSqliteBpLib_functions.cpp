...
void UKuroSqliteLibrary::QueryAsync(const class FString& DbPath, const class FString& Sql, class UKuroSqliteResultSet* ResultSet)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("KuroSqliteLibrary", "QueryAsync");

	Params::KuroSqliteLibrary_QueryAsync Parms{};
