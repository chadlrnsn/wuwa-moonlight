...
// TDelegate<void(const TArray<struct FDynamicAtlasSlotManagedHandle>& ManagedHandle)>CompleteCallback                                       (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
