...
public:
	...
	uint8                                         Pad_34D2[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FSSceneInteractionMaterialController) == 0x000028, "Wrong size on FSSceneInteractionMaterialController");
