...
bool UKuroLandscapeParametersData::SetLandscapeMaterialLayerParameters(class UWorld* World)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KuroLandscapeParametersData", "SetLandscapeMaterialLayerParameters");

	Params::KuroLandscapeParametersData_SetLandscapeMaterialLayerParameters Parms{};
...
// Function KuroRenderingRuntimeBPPlugin.KuroGlobalGI.ApplySceneRain
// (Final, Native, Public, BlueprintCallable)

void AKuroGlobalGI::ApplySceneRain()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KuroGlobalGI", "ApplySceneRain");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UKuroSceneRainEmitterConfig*      FrontRainConfig                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UKuroSceneRainEmitterConfig*      BackRainConfig                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AKuroGlobalGI::SetupSceneRain(class UKuroSceneRainEmitterConfig* FrontRainConfig, class UKuroSceneRainEmitterConfig* BackRainConfig)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KuroGlobalGI", "SetupSceneRain");

	Params::KuroGlobalGI_SetupSceneRain Parms{};

	Parms.FrontRainConfig = FrontRainConfig;
	Parms.BackRainConfig = BackRainConfig;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class AKuroRainActor*                   RainActor                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class AKuroRainActor*                   SnowActor                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UTexture2D*                       HeightTexture                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AKuroGlobalGI::UpdateAndApplyWeather(class AKuroRainActor* RainActor, class AKuroRainActor* SnowActor, class UTexture2D* HeightTexture)
{
	static class UFunction* Func = nullptr;
	...
	Params::KuroGlobalGI_UpdateAndApplyWeather Parms{};

	Parms.RainActor = RainActor;
	Parms.SnowActor = SnowActor;
	Parms.HeightTexture = HeightTexture;
...
bool AThunderGenerator::CalculateThunderPosition(const struct FTransform& CameraTransform, struct FVector* OutPosition)
{
	static class UFunction* Func = nullptr;
