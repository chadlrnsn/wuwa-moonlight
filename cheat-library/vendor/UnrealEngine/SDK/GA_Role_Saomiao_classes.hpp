...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Role_Saomiao_C;                  // 0x0530(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Role_Saomiao_C) == 0x000538, "Wrong size on UGA_Role_Saomiao_C");
static_assert(offsetof(UGA_Role_Saomiao_C, UberGraphFrame_GA_Role_Saomiao_C) == 0x000530, "Member 'UGA_Role_Saomiao_C::UberGraphFrame_GA_Role_Saomiao_C' has a wrong offset!");
